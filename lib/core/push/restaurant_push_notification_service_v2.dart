...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // Android renders FCM notification payloads itself in background.
  // Do not create another local notification for the same order.
  // Data-only messages still get exactly one local fallback notification.
